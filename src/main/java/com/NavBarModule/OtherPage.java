...
public class OtherPage {
	...
	@FindBy(xpath = "(//p[normalize-space()='Others'])")
	...
	public void OtherProductSection() throws InterruptedException {
		Thread.sleep(5000);
		Others.click();
		Thread.sleep(5000);
		if (BullionProductSection.isDisplayed()) {
			...
			System.out.println("Other product are not available");

		}

		else {
			System.out.println("Other products are not displayed.");
		}
