...
public class SellerStatus_PendingGoldDeposits {
	...
	public static WebElement pendingGoldDeposits;

	@FindBy(xpath = "//p[@class='fs-5']")
	public static WebElement SellerForDepositGoldText;
	...
	public SellerStatus_PendingGoldDeposits(WebDriver driver) {
	...
	public boolean isCommissionEarnedTextDisplayed() throws InterruptedException {
		Thread.sleep(2000);
		return SellerForDepositGoldText.isDisplayed();
	}
