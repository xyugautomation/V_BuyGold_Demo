...
public class NosePinsPage {
	...
	@FindBy(xpath = "(//p[contains(text(),'Nose Pins')])")
	WebElement NosePinsProductSection;

	public static WebDriver driver;

	public NosePinsPage(WebDriver driver) {
		PageFactory.initElements(driver, this);

	}

	public void NosePinsProductTest() {
	...
	public void NosePinsProductSection() throws InterruptedException {
		Thread.sleep(5000);
		NosePins.click();
		Thread.sleep(5000);
		if (NosePinsProductSection.isDisplayed()) {
